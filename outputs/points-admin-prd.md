...
- 使用门槛包含“完全免费”和“积分使用”。
- 选择“完全免费”时，免费规则直接平铺单选展示“不限次免费”和“每日免费 X 次”，X 为数字配置；此时不展示“每日可免费次数”“单次消耗积分数量”等积分使用规则字段。
- 选择“不限次免费”时，用户每天可无限次使用该工具，不需要录入次数。
- 选择“每日免费 X 次”时，X 必须为大于 0 的整数；当用户当日使用次数达到 X 后，前端需置灰使用按钮并提示今日免费次数已用完，该工具当天不再支持继续使用，次日重置。
- 选择“积分使用”时，仅展示“每日可免费次数”和“单次消耗积分数量”，不展示完全免费的免费规则。
- 积分使用下“每日可免费次数”必须为大于等于 0 的整数；当每日可免费次数配置为 0 时，默认用户每次使用都需要消耗积分。
- 积分使用下“单次消耗积分数量”必须为大于 0 的整数。
