...
单页不逛书。项目 Mock：`番茄小说`、`番茄漫剧`、`番茄短剧`（均无自有书库，有官方推荐）。待申词行：ID、书名或「未匹配书名」、词芯片。推荐数组独立拷贝，不 import FR-012。手填框约 2 行高。官方推荐可按书名/ID 搜索，每批最多 10 本，支持「更换」。申词结果为独立卡片。「立即申词」「立即题词」左右并排。
